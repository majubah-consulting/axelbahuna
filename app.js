...
const timeline = [
  ...
  { year: { fr: 'Date à confirmer', en: 'Date to be confirmed' }, title: { fr: 'Première exposition connue', en: 'First known exhibition' }, text: { fr: 'L’Imprimerie Pascal accueille ses œuvres. Il rejoint ensuite l’Académie des arts de Lisieux.', en: 'The Imprimerie Pascal hosts his works. He later joins the Académie des arts de Lisieux.' } },
